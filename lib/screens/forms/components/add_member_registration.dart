...
class _AddMemberRegistrationState extends State<AddMemberRegistration> {
  ...
  void initState() {
    ...
    if (widget.registrationData[0][0] == null &&
        widget.registrationData.isNotEmpty &&
        widget.registrationData[0][0].isNotEmpty) {
  ...
  Map<String, dynamic> getmemeberID() {
    List<Map<String, dynamic>> memData =
        []; //widget.registrationData[0]["memberCategory"];
  ...
  void submitData() {
    ...
    memberService.value.addDelegateTypeToDatabase(delegateTypeController.text,
        _selectedDelegate!, rate, uid // Pass the uid as String
        );
